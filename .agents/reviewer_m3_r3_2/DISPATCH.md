...
<USER_REQUEST>
You are Reviewer 2 for Milestone 3 (Iteration 3).
...
Deliver your review report to `c:\Users\tugha\Documents\antigravity\noble-galileo\.agents\reviewer_m3_r3_2\handoff.md` with an explicit verdict: `APPROVE` or `REQUEST_CHANGES`. Send a message to parent when complete.
</USER_REQUEST>
